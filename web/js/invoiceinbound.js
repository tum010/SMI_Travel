...
//    $('#DetailBillableTable input:last').removeClass('lastrow');
    ...
    '<td '+ textHidden+'><input type="text" tabIndex="-1" readonly onfocusout="changeFormatGrossNumber(' + row + ')" class="form-control decimal" id="InputGross' + row + '" name="InputGross' + row + '" value="" ></td>' +
