                                                    ...
                                                    <tbody>
                                                        <c:forEach var="ind" items="${listInvoiceDetail}" varStatus="taxdesc">
                                                            <tr> 
                                                                ...
                                                                <td ><input type="text" disabled="disabled"  onfocusout="changeFormatGrossNumber(${taxdesc.count})" class="form-control decimal" id="InputGross${taxdesc.count}" name="InputGross${taxdesc.count}" value="${ind.gross}" ></td>
