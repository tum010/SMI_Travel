...
//    }
    ...
    public List getTaxInvoiceEmail(String taxInvId,int option,String sign,String printby){
        return taxInvoiceDao.getTaxInvoice(taxInvId,option,sign,printby);
    }
    ...
    public List getInvoice(String InvoiceId,String BankId,String showStaff,String showLeader,String sign,String printBy,String isTemp,int typeInvoice){
        return invoicedao.getInvoice(InvoiceId, BankId,showStaff,showLeader,sign,printBy,isTemp,typeInvoice);
    }
    ...
    public List getTicketFareReport(String ticketType,String ticketBuy,String airline,String airlineC,String airlineCode,String dateFrom,String dateTo,String department,String staff,String termPay,String printby,String invdateFrom,String invdateTo,String reportType ){      
        return ticketFareReportDao.getTicketFareReport(ticketType,ticketBuy,airline,airlineC,airlineCode,dateFrom,dateTo,department,staff,termPay,printby,invdateFrom,invdateTo,reportType);
    }
...
//    }
    ...
    public List getBookingInvoiceReport(String owner,String invto,String bookdatefrom,String bookdateto,String invdatefrom,String invdateto,String printby) {
        return bookingSummaryDao.getBookingInvoiceReport(owner, invto, bookdatefrom, bookdateto, invdatefrom, invdateto, printby);
    }
    ...
    public List getBookingNonInvoiceReport(String owner,String invsup,String bookdatefrom,String bookdateto,String paydatefrom,String paydateto,String printby) {
        return bookingSummaryDao.getBookingNonInvoiceReport(owner, invsup, bookdatefrom, bookdateto, paydatefrom, paydateto, printby);
    }
