 ...
 * @author chonnasith
 */
public class RefundAirReport {
    private String refundno;
    private String ticketdate;
    private String passenger;
    private String ticketno;
    private String sectorissue;
    ...
    public String getSectorissue() {
        return sectorissue;
    }

    public void setSectorissue(String sectorissue) {
        this.sectorissue = sectorissue;
    }
