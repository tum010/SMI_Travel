...
public class TicketFareReport {
    ...
    public String getHeadtermpay() {
        return headtermpay;
    }

    public void setHeadtermpay(String headtermpay) {
        this.headtermpay = headtermpay;
    }
    ...
    public void setTicketcom(String ticketcom) {
