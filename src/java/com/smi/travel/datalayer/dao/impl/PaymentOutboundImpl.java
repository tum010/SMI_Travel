...
//        HqlQuery.setMaxResults(MAX_ROW);
    ...
    public List getPaymentSummaryReport(String fromDate, String toDate, String saleby, String invSupCode, String refNo, String username) {
        ...
        List<Object[]> QueryTicketList = session.createSQLQuery(Query)
                ...
                .addScalar("noticket", Hibernate.STRING)
                .addScalar("description", Hibernate.STRING)
                .addScalar("periodin", Hibernate.STRING)
                .addScalar("periodout", Hibernate.STRING)
        ...
        for (Object[] B : QueryTicketList) {
            ...
            sum.setInvdate(util.convertStringToDateFormat(String.valueOf(B[4])));
            ...
            sum.setDepartdate(util.convertStringToDateFormat(String.valueOf(B[15])));
            ...
            sum.setPaydate(util.convertStringToDateFormat(String.valueOf(B[20])));
            ...
            sum.setPaycomdate(util.convertStringToDateFormat(String.valueOf(B[34])));
            ...
            sum.setReceiptdate(util.convertStringToDateFormat(String.valueOf(B[40])));
            sum.setNoticket(util.ConvertString(B[41]));
...
//            pplv.setGroupData(groupbytemp);
    ...
    public List getPaymentProfitLossVolumnReport(String departFromDate, String departToDate, String invFromDate, String invToDate, String ownercode, String city, String producttypeid, String invsupcode, String payFromDate, String payToDate, String groupby) {
        ...
        query += " as data , sum(sale) as sumsale , sum(cost) as sumcost , sum(profit) as sumprofit FROM `payment_profitloss` ";
        ...
        List<Object[]> QueryList = session.createSQLQuery(query)
                ...
                .addScalar("sumsale", Hibernate.STRING)
                .addScalar("sumcost", Hibernate.STRING)
                .addScalar("sumprofit", Hibernate.STRING)
                .list();         
        String groupbytemp = "";        
        for (Object[] B : QueryList) {            
            PaymentProfitLossView pplv = new PaymentProfitLossView();
            ...
            pplv.setProducttype(B[22] != null ? util.ConvertString(B[22]) : "");         
            pplv.setSale(B[23] != null ? util.ConvertString(B[23]) : "0.00");
            pplv.setCost(B[24] != null ? util.ConvertString(B[24]) : "0.00");
            pplv.setProfit(B[25] != null ? util.ConvertString(B[25]) : "0.00");          
            data.add(pplv);            
        }
        session.close();
        this.sessionFactory.close();
