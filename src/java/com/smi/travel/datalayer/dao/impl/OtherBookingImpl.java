...
public class OtherBookingImpl implements OtherBookingDao{
    ...
    private static final String GET_BOOKOTHER_QUERY = "from OtherBooking ot where ot.otherDate >= :startdate and ot.otherDate <= :enddate and ot.master.bookingType = 'I' and ot.status.id = 1 and ot.master.MBookingstatus.id != 3 and ot.master.MBookingstatus.id != 4 ";
