...
public class TourOperationImpl implements TourOperationDao {
    ...
    private static final String TOURJOB_QUERY = "from DaytourBooking DB Where DB.tourDate >= :thisdate and (DB.master.MBookingstatus.id = '1' or DB.master.MBookingstatus.id = '2' ) and DB.MItemstatus.id = '1' Group By DB.daytour.code , DB.tourDate order by DB.tourDate asc , DB.daytour.code asc  ";
