...
public class TourOperationImpl implements TourOperationDao {
    ...
    private static final String TOURJOB_QUERY = "from DaytourBooking DB Where DB.tourDate >= :thisdate  Group By DB.daytour.code , DB.tourDate order by DB.tourDate";
    private static final String TOURDETAIL_QUERY = "from DaytourBooking DB where DB.daytour.id = :tourid and DB.tourDate = :date  ";
