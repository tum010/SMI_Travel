...
public class TicketSummaryCommissionImpl implements TicketSummaryCommissionDao{
    ...
    public List<TicketSummaryCommissionView> searchTicketSummaryCommission(String invoicefromdatePage, String invoicetodatePage, String issuefromdatePage, String issuetodatePage, String agentcomfromdatePage, String agentcomtodatePage, String ticketcomfromdatePage, String ticketcomtodatePage, String overfromdatePage, String overtodatePage, String littlefromdatePage, String littletodatePage, String agemtcomreceivefromdatePage, String agemtcomreceivetodatePage, String comrefundfromdatePage, String comrefundtodatePage, String addpayfromdatePage, String addpaytodatePage, String decreasepayfromdatePage, String decreasepaytodatePage, String typeRoutingPage, String routingDetailPage, String airlineCodePage, String agentCodePage, String agentNamePage, String ticketnoPagePage, String departmentPage, String salebyUserPage, String salebyNamePage, String termPayPage,String printby) {
        ...
        for (Object[] B : ticketSummaryCommissionList) {
            ...
            ticket.setAmountwendy((util.ConvertString(B[13])) == "" ? "" : util.ConvertString(B[13]));
            ticket.setAmountoutbound((util.ConvertString(B[14])) == "" ? "" : util.ConvertString(B[14]));
            ticket.setSale((util.ConvertString(B[15])) == "" ? "" : util.ConvertString(B[15]));
            ticket.setCost((util.ConvertString(B[16])) == "" ? "" : util.ConvertString(B[16]));
            ticket.setOver((util.ConvertString(B[17])) == "" ? "" : util.ConvertString(B[17]));
            ticket.setAdd((util.ConvertString(B[18])) == "" ? "" : util.ConvertString(B[18]));
            ticket.setDres((util.ConvertString(B[19])) == "" ? "" : util.ConvertString(B[19]));
            ticket.setProfit((util.ConvertString(B[20])) == "" ? "" : util.ConvertString(B[20]));
            ticket.setTiccomm((util.ConvertString(B[21])) == "" ? "" : util.ConvertString(B[21]));
            ticket.setLittle((util.ConvertString(B[22])) == "" ? "" : util.ConvertString(B[22]));
            ticket.setAgentcomm((util.ConvertString(B[23])) == "" ? "" : util.ConvertString(B[23]));
            ticket.setPay((util.ConvertString(B[24])) == "" ? "" : util.ConvertString(B[24]));
            ticket.setComm((util.ConvertString(B[25])) == "" ? "" : util.ConvertString(B[25]));
