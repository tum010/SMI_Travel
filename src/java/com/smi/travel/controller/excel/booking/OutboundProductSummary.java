...
//            }
        ...
        HSSFCell cell65 = row5.createCell(16);
            cell65.setCellValue("NO TICKET");
            cell65.setCellStyle(styleHeader);
            sheet.autoSizeColumn(16); 
        HSSFCell cell66 = row5.createCell(17);
            cell66.setCellValue("DESCRIPTION");
            cell66.setCellStyle(styleHeader);
            sheet.autoSizeColumn(17); 
        HSSFCell cell67 = row5.createCell(18);
            cell67.setCellValue("PERIOD OF USED");
            cell67.setCellStyle(styleHeader);
            sheet.autoSizeColumn(18); 
        HSSFCell cell68 = row5.createCell(20);
            cell68.setCellValue("QTY");
            cell68.setCellStyle(styleHeader);
            sheet.autoSizeColumn(20); 
        HSSFCell cell69 = row5.createCell(23);
            cell69.setCellValue("PRICE");
            cell69.setCellStyle(styleHeader);
            sheet.autoSizeColumn(23);
        HSSFCell cell70 = row5.createCell(24);
            cell70.setCellValue("ACC");
            cell70.setCellStyle(styleHeader);
            sheet.autoSizeColumn(24); 
        HSSFCell cell71 = row5.createCell(25);
            cell71.setCellValue("PAID");
            cell71.setCellStyle(styleHeader);
            sheet.autoSizeColumn(25); 
        HSSFCell cell72 = row5.createCell(33);
            cell72.setCellValue("AMOUNT LOCAL (P)");
            cell72.setCellStyle(styleHeader);
            sheet.autoSizeColumn(33);
        HSSFCell cell73 = row5.createCell(34);
            cell73.setCellValue("AMOUNT LOCAL (R)");
            cell73.setCellStyle(styleHeader);
            sheet.autoSizeColumn(34);
        HSSFCell cell74 = row5.createCell(35);
            cell74.setCellValue("VAT");
            cell74.setCellStyle(styleHeader);
            sheet.autoSizeColumn(35);
        HSSFCell cell75 = row5.createCell(36);
            cell75.setCellValue("WHT");
            cell75.setCellStyle(styleHeader);
            sheet.autoSizeColumn(36);
        HSSFCell cell76 = row5.createCell(37);
            cell76.setCellValue("GROSS PROFIT");
            cell76.setCellStyle(styleHeader);
            sheet.autoSizeColumn(37);
        HSSFCell cell77 = row5.createCell(39);
            cell77.setCellValue("PAYCOM");
            cell77.setCellStyle(styleHeader);
            sheet.autoSizeColumn(39); 
        HSSFCell cell78 = row5.createCell(43);
            cell78.setCellValue("PROFIT BALANCE");
            cell78.setCellStyle(styleHeader);
            sheet.autoSizeColumn(43); 
        HSSFCell cell79 = row5.createCell(44);
            cell79.setCellValue("RECEIPT NO");
            cell79.setCellStyle(styleHeader);
        ...
        sheet.addMergedRegion(CellRangeAddress.valueOf("S8:T8"));
        sheet.addMergedRegion(CellRangeAddress.valueOf("U8:W8"));
        sheet.addMergedRegion(CellRangeAddress.valueOf("Z8:AG8"));
...
//        row5.createCell(31).setCellStyle(styleBorderRight); 
        ...
        String merge[] = {"A","B","C","D","E","F","G","H","I","M","N","O","P","Q","R","X","Y","AH","AI","AJ","AK","AR","AS","AT"};   
        ...
        for(int i=0;i<listPaymentSummary.size();i++){
            ...
            HSSFCell celldata16 = row.createCell(16);
                celldata16.setCellValue(String.valueOf(data.getNoticket()));
                celldata16.setCellStyle(styleAlignLeftBorderAll);
            HSSFCell celldata17 = row.createCell(17);
                celldata17.setCellValue(String.valueOf(data.getDescription()));
                celldata17.setCellStyle(styleAlignLeftBorderAll);  
            HSSFCell celldata18 = row.createCell(18);
                celldata18.setCellValue(String.valueOf(data.getPeriodin()));
                celldata18.setCellStyle(styleAlignLeftBorderAll);
            HSSFCell celldata19 = row.createCell(19);
                celldata19.setCellValue(String.valueOf(data.getPeriodout()));
                celldata19.setCellStyle(styleAlignLeftBorderAll);
            HSSFCell celldata20 = row.createCell(20);
                celldata20.setCellValue(String.valueOf(data.getQtyroom()));
                celldata20.setCellStyle(styleDetailTableCenter); 
            HSSFCell celldata21 = row.createCell(21);
                celldata21.setCellValue(String.valueOf(data.getQtynight()));
                celldata21.setCellStyle(styleDetailTableCenter);  
            HSSFCell celldata22 = row.createCell(22);
                celldata22.setCellValue(String.valueOf(data.getQtyttl()));
                celldata22.setCellStyle(styleDetailTableCenter);        
                
            HSSFCell celldata23 = row.createCell(23);
                celldata23.setCellValue("".equalsIgnoreCase(String.valueOf(data.getPrice())) ? 0 : (new BigDecimal(data.getPrice())).doubleValue());
                celldata23.setCellStyle(styleAlignRightBorderAllNumber);    
            HSSFCell celldata24 = row.createCell(24);
                celldata24.setCellValue(String.valueOf(data.getAcc()));
                celldata24.setCellStyle(styleDetailTableCenter);    
            HSSFCell celldata25 = row.createCell(25);
                celldata25.setCellValue(String.valueOf(data.getPvno()));
                celldata25.setCellStyle(styleAlignLeftBorderAll);    
            HSSFCell celldata26 = row.createCell(26);
                celldata26.setCellValue(String.valueOf(data.getPaydate()));
                celldata26.setCellStyle(styleDetailTableCenter);    
            HSSFCell celldata27 = row.createCell(27);
                celldata27.setCellValue(String.valueOf(data.getInvsup()));
                celldata27.setCellStyle(styleAlignLeftBorderAll);    
            HSSFCell celldata28 = row.createCell(28);
                celldata28.setCellValue(String.valueOf(data.getPayinvno()));
                celldata28.setCellStyle(styleAlignLeftBorderAll);
            ...
            HSSFCell celldata34 = row.createCell(34);
                celldata34.setCellValue("".equalsIgnoreCase(String.valueOf(data.getAmountlocalr())) ? 0 : (new BigDecimal(data.getAmountlocalr())).doubleValue());
            ...
            HSSFCell celldata42 = row.createCell(42);
                celldata42.setCellValue(String.valueOf(data.getPaycommission().trim()));
