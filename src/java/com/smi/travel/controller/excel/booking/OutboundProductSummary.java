...
//        row5.createCell(9).setCellStyle(styleBorderTop);
...
//        row5.createCell(15).setCellStyle(styleBorderTop);
        ...
        HSSFCell cell6877 = row5.createCell(17);
            cell6877.setCellStyle(styleHeader);
        HSSFCell cell687 = row5.createCell(18);
            cell687.setCellStyle(styleHeader);
        HSSFCell cell697 = row5.createCell(19);
            cell697.setCellStyle(styleHeader);
        HSSFCell cell707 = row5.createCell(20);
            cell707.setCellStyle(styleHeader);
